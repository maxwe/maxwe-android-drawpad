...
public class ColorPicker extends AlertDialog{
	...
	public ColorPicker(Context context, String title, OnColorChangedListener listener) {
		this(context, Color.BLACK, title, listener);
	}

	public ColorPicker(Context context, int initialColor, String title, OnColorChangedListener listener) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ColorPickerView myView = new ColorPickerView(context, 1280, 800);
